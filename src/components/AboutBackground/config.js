export default {
    ...
    },
    {
        ...
        company: "Izoox",
        text: "Shortly after Galvanize I landed a job with a web development startup called Izoox. I learned a ton and worked on a lot of cool projects. I single handedly built the entire UI for a React-Native app, built new features on sites in various frameworks and languages, and was given a lot of freedom to build things the way I wanted. I enjoyed my time at Izoox, but was laid off in the summer of 2020 after Covid disrupted many of our clients businesses.",
        dates: [
            'Jun. 2020',
            'Jul. 2019'
        ]
    },
    {
        title: "Student",
        company: "Galvanize",
        text: "By mid 2018 I was pretty burnt out and needed a change. I wanted to be challenged in a new way, and also live a more flexible lifestyle. Learning to code satisfied both of those conditions. I found I enjoyed the logical problem solving as well as the creative outlet that web/app development provided. So I signed up for Galvanize's 6 month web development immersive program and learned how to code.",
        dates: [
            'Mar. 2019',
            'Oct. 2018'
        ]
    },
    {
...

      {
        ...
        text: `In May of 2015 I graduated from college with a Bachelor of Science in Packaging.  Green behind the ears, naive, and "ready" to take on the world.`,
        dates: [
            'May. 2015',
            'Sep. 2010'
        ]
